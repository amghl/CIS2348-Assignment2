...
public class Student {
    ...
    public static void getInfo(int count) { //validate data under each statement
        ...
        String re = "^[a-zA-Z]+(([',. -][a-zA-Z ])?[a-zA-Z]*)*$";               //regex expressions
        ...
        for (int x = 0; x < count; x++) {                               //validate data entered
            ...
            address1 = JOptionPane.showInputDialog("Enter Address Line 1     (ex: 123 calhoun rd(can be RD/rd/street/st etc.)): ");
